...
**Live:** [https://relaxed-weasel-karakeep.cloud.nexlayer.ai](https://relaxed-weasel-karakeep.cloud.nexlayer.ai)  
...
**karakeep** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  - name: app
    ...
    - 3000
    vars:
      NEXTAUTH_SECRET: "a1b2c3d4e5f6a1b2c3d4"
      NEXTAUTH_URL: "https://relaxed-weasel-karakeep.cloud.nexlayer.ai"
      DATABASE_URL: "postgresql://karakeep:${POSTGRES_PASSWORD}@postgres.pod:5432/karakeep"
